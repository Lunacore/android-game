...
import br.com.lunacore.awesome.objects.GameObject;
import br.com.lunacore.awesome.objects.GameParticle;
import br.com.lunacore.awesome.objects.KeyMapper;
import br.com.lunacore.awesome.objects.ObjectInfo;
import br.com.lunacore.awesome.objects.TmxRenderer;
...
public abstract class State{
	...
	public void inputAxis(KeyMapper.Device device, String axisName, float value) {
		for(int i = gos.size() - 1; i>= 0; i --) {
