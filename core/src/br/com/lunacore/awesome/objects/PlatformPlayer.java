...
public abstract class PlatformPlayer extends GameObject{
	...
	public PlatformPlayer(ObjectInfo info, MapProperties properties) {
		...
		getState().manager.registerKey("Left", KeyMapper.Device.KEYBOARD, Keys.A);
		getState().manager.registerKey("Right", KeyMapper.Device.KEYBOARD, Keys.D);
		getState().manager.registerKey("Jump", KeyMapper.Device.KEYBOARD, Keys.W);
		
		getState().manager.registerKey("Left", KeyMapper.Device.CONTROLLER, XBoxController.POV_LEFT);
		getState().manager.registerKey("Right", KeyMapper.Device.CONTROLLER, XBoxController.POV_RIGHT);
		getState().manager.registerKey("Jump", KeyMapper.Device.CONTROLLER, XBoxController.POV_UP);
	}
